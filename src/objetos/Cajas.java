...
import interfacesGraficas.ListadoDeArticulos;
 ...
 * @author mauro
 */
public class Cajas implements Cajeables{
    private int numero;
    ...
    public static void BackapearCajas(){
        ...
        while(itL.hasNext()){
            ...
            sql="insert into caja(numero,numerosucursal,numerousuario,tipomovimiento,saldoinicial,estado,tipo) values ("+caja.getNumero()+","+caja.getSucursal()+","+caja.getUsuario().getNumeroId()+","+caja.getTipoMovimiento()+","+caja.getSaldoInicial()+","+esta+","+caja.getTipo()+")";
    ...
    public Object AbrirCaja(Object caja) {
       ...
       try {
            ...
            String sql="insert into caja (numeroSucursal,numeroUsuario,tipoMovimiento,saldoInicial,tipo,estado) values ("+Inicio.sucursal+","+Inicio.usuario.getNumero()+",9,"+cajaNueva.saldoInicial+","+tipo+",0)";
            tra.guardarRegistro(sql);
            ...
            */
                ...
                sql="insert into movimientoscaja (numeroUsuario,numeroSucursal,monto,tipoMovimiento,idCaja,numerocomprobante,tipocomprobante,pagado) values ("+Inicio.usuario.getNumeroId()+","+Inicio.sucursal+","+cajaNueva.getSaldoInicial()+",9,"+cajaNumeroAct+","+nume+",0,0)";
                tra.guardarRegistro(sql);
            ...
            sql="insert into caja (numero,numeroSucursal,numeroUsuario,tipoMovimiento,saldoInicial,tipo,estado) values ("+cajaNumeroAct+","+Inicio.sucursal+","+Inicio.usuario.getNumero()+",9,"+saldoI+","+tipo+",0)";
    ...
    public Boolean CerrarCaja(Object caja) {
        ...
        if(Inicio.numeroCajaAdministradora.equals(cajj.getNumero())){
            ...
            sql="insert into movimientoscaja (numeroUsuario,numeroSucursal,numeroComprobante,tipoComprobante,monto,tipoMovimiento,idCaja,idCliente,tipoCliente,pagado) values ("+Inicio.usuario.getNumeroId()+","+Inicio.sucursal+","+cajj.getNumeroDeComprobante()+","+cajj.getTipoDeComprobante()+","+montt+",10,"+Inicio.numeroCajaAdministradora+",0,0,1)";
            verif=tra.guardarRegistro(sql);
        }
    ...
    public Boolean NuevoMovimiento(Object factura) {
        ...
        System.err.println(Inicio.usuario.getNumeroId()+","+Inicio.sucursal+","+caj.getNumeroDeComprobante()+","+caj.getTipoDeComprobante()+","+caj.getMontoMovimiento()+","+caj.getTipoMovimiento()+","+caj.getNumero()+",0,");
    ...
    public DefaultListModel LeerComprobante(Integer idComprobante,Integer tipoComprobante,Integer tipoMovimiento) {
       ...
       //JOptionPane.showMessageDialog(null," tipo de movimienot "+tipoMovimiento);
        ...
        try {
           ...
           case 13:
               //cobro cta cte clientes -- leo en movimientos caja, devuelvo un obejto caja
               sql="select movimientoscaja.fecha,movimientoscaja.monto,(select listcli.RAZON_SOCI from listcli where listcli.codMMd=movimientoscaja.idCliente)as nombreP from movimientoscaja where tipoComprobante="+tipoComprobante+" and numeroComprobante="+idComprobante+" and numeroUsuario="+Inicio.usuario.getNumeroId()+" and movimientoscaja.tipoMovimiento=5"; 
               System.out.println(sql);
               rs=tra.leerConjuntoDeRegistros(sql);
        try {
            while(rs.next()){
