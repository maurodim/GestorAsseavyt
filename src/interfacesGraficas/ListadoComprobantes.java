...
public class ListadoComprobantes extends javax.swing.JDialog {
 private Integer idComp;
     ...
     */
    public ListadoComprobantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoComprobantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListadoComprobantes dialog = new ListadoComprobantes(new javax.swing.JFrame(), true);
