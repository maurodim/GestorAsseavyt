...
public class IngresoDePedidos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Buscar Cuenta");
	...
	String ano=Integer.toString(c2.get(Calendar.YEAR));
        ...
        int comprobanteTipo=(int) Inicio.sucursal;
        if(cliT.getCondicionIva().equals("RI "))comprobanteTipo=(int)Inicio.sucursal;
        ...
        comprobante.setIdSucursal(Inicio.sucursal);
        comprobante.setIdDeposito(Inicio.deposito);
